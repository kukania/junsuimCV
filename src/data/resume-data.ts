  ...
  work: [
    {
      ...
      description: "",
      highlights: [
        "Developing cross-regional consistency monitoring system for distributed in-memory caching system",
        "Developing overloading protection mechanism for distributed in-memory caching system",
      ],
    },
    {
